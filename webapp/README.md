...
### word2vec
- download word2vec model for English from https://drive.google.com/file/d/0B7XkCwpI5KDYNlNUTTlSS21pQmM/edit?usp=sharing
- Extract the model file, and copy it to the 'models' directory
```
